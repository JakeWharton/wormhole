...
class AndroidWormhole : Plugin<Project> {
  override fun apply(project: Project) {
    ...
    project.plugins.withType(pluginType) {
      ...
      val voodoo = GroovyVoodoo(Function(extension::wormhole), Function(extension::wormhole))
      voodoo.applyTo(extension)
    }
  }
}

fun BaseExtension.wormhole(api: Int) = wormhole("android-$api")

fun BaseExtension.wormhole(platform: String): String {
